...
#define IMU_INT1_Pin LL_GPIO_PIN_12
#define IMU_INT1_GPIO_Port GPIOB
#define IMU_SCL_Pin LL_GPIO_PIN_13
#define IMU_SCL_GPIO_Port GPIOB
#define IMU_SDA_Pin LL_GPIO_PIN_14
#define IMU_SDA_GPIO_Port GPIOB
#define IMU_SA0_Pin LL_GPIO_PIN_15
#define IMU_SA0_GPIO_Port GPIOB
#define IMU_MODE_SEL_Pin LL_GPIO_PIN_8
#define IMU_MODE_SEL_GPIO_Port GPIOD
#define IMU_INT2_Pin LL_GPIO_PIN_10
